...
if (!obj_room_controller.boss_spawned) {
    ...
    draw_text(room_width / 2, 20, "Boss in: " + string(minutes) + ":" + string(secs));
}
...
if (obj_room_controller.boss_killed) {
    ...
    draw_text(room_width / 2, 20, "Survival: " + string(minutes2) + ":" + string(secs2));
}

draw_set_halign(fa_left);

// Floor level
draw_text(10, 100, "Floor: " + string(obj_room_controller.floor_level));

// Kill count
draw_text(120, 60, "Kills: " + string(obj_room_controller.kill_count));
