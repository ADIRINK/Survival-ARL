...
var l2412E72D_0 = false;l2412E72D_0 = instance_exists(obj_enemy_parent);if(l2412E72D_0){	/// @DnDAction : YoYo Games.Instances.If_Instance_Exists
	...
	var l246DE391_0 = false;l246DE391_0 = instance_exists(obj_boss);if(l246DE391_0){	/// @DnDAction : YoYo Games.Common.Variable
		...
		/// @DnDHash : 257EA59F
		/// @DnDParent : 246DE391
		/// @DnDArgument : "expr" "point_distance(x, y, boss_target.x, boss_target.y) <= obj_player.current_range"
		if(point_distance(x, y, boss_target.x, boss_target.y) <= obj_player.current_range){	/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
			/// @DnDHash : 1ED30506
			/// @DnDInput : 2
			/// @DnDParent : 257EA59F
